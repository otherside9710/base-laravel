                ...
                <div class="col-md-4 banner-section d-none d-md-flex align-items-stretch justify-content-center">
                    <div class="bg-1">
                        <video id="video-banner" autoplay="" muted="" loop="">
                            <source src="{{asset('video/timelapse.mp4')}}" type="video/mp4">
                        </video>
                    </div>
                </div>
                <div class="col-12 col-md-8 h-100 bg-white">
                    <div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
                        <div class="nav-get-started">
                            <img src="{{asset('images/xiltrion.png')}}" height="40px" width="170px">
                        </div>
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="wrapper mt-5 text-gray">
                                <p class="footer-text">Copyright © 2018 Datafis S.A.S. All rights reserved.</p>
                            </div>
                        </form>
                    </div>
                </div>
